...
const destinationItems: MenuItem[] = [
    { name: 'Maldives', routePath: '/maldives' },
    { name: 'Thailand', routePath: '/thailand' },
    { name: 'Turkey', routePath: '/turkey' },
    { name: 'Japan', routePath: '/japan' },
    { name: 'Indonesia', routePath: '/indonesia' },
    { name: 'Italy', routePath: '/Italy' },
    { name: 'Greece', routePath: '/greece' },
    { name: 'France', routePath: '/france' },
    { name: 'China', routePath: '/china' },
    { name: 'Dubai', routePath: '/dubai' },
    { name: 'Egypt', routePath: '/egypt' },
                ...
                <div>
                    ...
                    <div className="bg-white">
                        <ul className="flex flex-col">
                            ...
                            >
                                Destinations
                                <ChevronIcon isOpen={subMenu === 'destinations'} />
                            </li>
                            <div
                                className={`transition-all duration-300 ease-in-out overflow-hidden ${subMenu === 'destinations' ? 'max-h-128' : 'max-h-0'}`}
                            >
                                {renderMenuItems(destinationItems)}
                            </div>
                        </ul>
                    </div>
                    <div className="p-4 bg-white flex justify-between items-center">
