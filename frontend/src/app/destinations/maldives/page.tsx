...
export const metadata: Metadata = {
    title: 'Best Maldives Holidays & All-Inclusive Resorts 2025 | Book Luxury Packages',
    description: 'Plan your perfect Maldives holiday in 2024/25. Explore exclusive all-inclusive resorts, luxury water villas, and honeymoon specials with unbeatable deals.',
    keywords: 'Maldives holidays, Maldives all-inclusive, Maldives holiday package, Maldives resorts, Maldives hotels, Maldives vacation, Siyam World Maldives',
    alternates: {
      canonical: 'https://haloholidays.com/destinations/maldives'
    },
    openGraph: {
      title: 'Best Maldives Holidays & All-Inclusive Resort Packages 2024',
      description: 'Explore the top Maldives hotels, all-inclusive resorts, and luxury water villas with exclusive deals and unbeatable experiences.',
      type: 'website',
      locale: 'en_GB',
      images: [
        {
          url: '/images/destinations/maldives/og-image.jpg',
          width: 1200,
          height: 630,
...
const schemaData = {
  ...
  "name": "Maldives All-Inclusive Resorts",
  "description": "Book Maldives holiday packages with top-rated luxury water villas and all-inclusive resorts for 2024/25.",
  "url": "https://haloholidays.com/destinations/maldives",
  "touristType": ["Couples", "Families", "Luxury Travelers", "Honeymooners"],
  "aggregateRating": {
  ...
  "includesAttraction": [
    {
      ...
      "name": "Luxury Water Villas Maldives",
      "description": "Book an exclusive Maldives overwater villa with a private pool and direct lagoon access."
    },
    {
      "@type": "TouristAttraction",
      "name": "All-Inclusive Maldives Resorts",
      "description": "Discover the best all-inclusive Maldives holiday packages featuring premium amenities and gourmet dining."
    }
  ]
};
...
const packageSchema = {
  "@context": "https://schema.org",
  "@type": "Product",
  "name": "Maldives Holiday Package 2024 - All Inclusive",
  "description": "Exclusive all-inclusive Maldives holiday package featuring luxury water villas, private transfers, and gourmet dining.",
  "brand": {
    "@type": "Brand",
    "name": "Halo Holidays"
  },
...
// Schema data remains same as original
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
            {maldivesHotels.slice(0, 3).map((hotel, index) => (
              <div key={index} className="group bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <Link 
            href={`/destinations/maldives/hotel/${hotel.slug.toLowerCase().replace(/\s+/g, '-')}`}
  ...
  <div className="container mx-auto px-4">
    ...
    <div className="grid lg:grid-cols-2 gap-12">
      <div className="relative h-[500px] rounded-2xl overflow-hidden">
        <Image
          src="/images/destinations/maldives/Honeymoon.png"
