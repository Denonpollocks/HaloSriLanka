        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-gray-600">
              Discover our handpicked collection of Greece's finest hotels and resorts
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
            ...
            <div className="group bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300">
              <div className="relative h-[300px] overflow-hidden">
                <Image
                  src="/images/destinations/greece/grace-santorini.jpg"
                  alt="Grace Santorini"
                  fill
                ...
                <div className="absolute bottom-4 left-4 text-white">
                  <p className="text-sm font-medium">Santorini</p>
                  <h3 className="text-2xl font-bold">Grace Santorini</h3>
                </div>
              ...
              <div className="p-6">
                ...
                <div className="space-y-3">
                  {['Infinity Pool', 'Caldera Views', 'Luxury Spa', 'Fine Dining'].map((feature, index) => (
            ...
            <div className="group bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300">
              <div className="relative h-[300px] overflow-hidden">
                <Image
                  src="/images/destinations/greece/amanzoe-resort.jpg"
                  alt="Amanzoe Resort"
                  fill
                  className="object-cover group-hover:scale-110 transition-transform duration-500"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent" />
                <div className="absolute bottom-4 left-4 text-white">
                  <p className="text-sm font-medium">Porto Heli</p>
                  <h3 className="text-2xl font-bold">Amanzoe</h3>
                </div>
                <div className="absolute top-4 right-4 bg-pink-600 text-white px-3 py-1 rounded-full text-sm">
                  From €1,200
                </div>
              ...
              <div className="p-6">
                <div className="flex items-center gap-2 mb-4">
                  <span className="text-yellow-400">★</span>
                  <span className="font-medium">4.9</span>
                  <span className="text-gray-500 text-sm">(650 reviews)</span>
                </div>
                
                <div className="space-y-3">
                  {['Private Beach', 'Helicopter Transfer', 'Wellness Center', 'Private Villas'].map((feature, index) => (
                    <div key={index} className="flex items-center gap-2 text-gray-700">
                      <CheckIcon className="w-5 h-5 text-pink-600" />
                      {feature}
                    </div>
            ...
            <div className="group bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300">
              <div className="relative h-[300px] overflow-hidden">
                <Image
                  src="/images/destinations/greece/mystique-santorini.jpg"
                  alt="Mystique Santorini"
                  fill
                  className="object-cover group-hover:scale-110 transition-transform duration-500"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent" />
                <div className="absolute bottom-4 left-4 text-white">
                  <p className="text-sm font-medium">Santorini</p>
                  <h3 className="text-2xl font-bold">Mystique</h3>
                </div>
                <div className="absolute top-4 right-4 bg-pink-600 text-white px-3 py-1 rounded-full text-sm">
                  From €900
                </div>
              ...
              <div className="p-6">
                ...
                <div className="space-y-3">
                  {['Wine Cave', 'Infinity Pool', 'Aegean Views', 'Gourmet Dining'].map((feature, index) => (
                    <div key={index} className="flex items-center gap-2 text-gray-700">
                      <CheckIcon className="w-5 h-5 text-pink-600" />
                      {feature}
                    </div>
