  ...
  return (
    <main className="min-h-screen">
      <header className="relative h-[80vh] flex items-center">
        <Image
          src="/images/destinations/indonesia/bali-temple.jpg"
          alt="Ancient Temple in Bali at Sunset"
          fill
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-gray-600">
              Discover our curated collection of Indonesia&apos;s most prestigious resorts
            </p>
          </div>
            ...
            {[
              {
                title: "Amankila",
                location: "Bali",
                image: "/images/destinations/indonesia/amankila.jpg",
                price: "From IDR 15,000,000 per night"
              },
              {
                title: "Four Seasons Jimbaran Bay",
                location: "Bali",
                image: "/images/destinations/indonesia/four-seasons-bali.jpg",
                price: "From IDR 12,000,000 per night"
              },
              {
                title: "Nihi Sumba",
                location: "Sumba Island",
                image: "/images/destinations/indonesia/nihi-sumba.jpg",
                price: "From IDR 18,000,000 per night"
              }
            ].map((hotel, index) => (
